 ...
 * @author TOSHIBA DC
 */
public class pglbarang extends javax.swing.JDialog {
    Connection conn;
    Statement st;
    ResultSet rs;
     ...
     */
    public pglbarang(java.awt.Frame parent, boolean modal) {
        super(parent, modal);
        initComponents();
...
/**
    ...
    private void initComponents() {
        ...
        jPanel2.add(jScrollPane1, new org.netbeans.lib.awtextra.AbsoluteConstraints(10, 90, 450, 170));
        ...
        jPanel2.add(cariTF, new org.netbeans.lib.awtextra.AbsoluteConstraints(178, 50, 230, 40));
        ...
        jPanel2.add(xBT, new org.netbeans.lib.awtextra.AbsoluteConstraints(410, 50, -1, 40));
    ...
    private void jTable1MouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_jTable1MouseClicked
        ...
        fAB.Kober =jTable1.getValueAt(barang,0).toString();
          fAB.Nabar =jTable1.getValueAt(barang,1).toString();
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(pglbarang.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                pglbarang dialog = new pglbarang(new javax.swing.JFrame(), true);
