...
public class masuk extends javax.swing.JInternalFrame {
    ...
    private void otomatis(){
        try {
            setKoneksi();
            String sql="select right (notransaksi,2)+1 from masuk";
   ...
   private void simpan(){
        ...
        try{
            setKoneksi();
            String sql="insert into masuk values('"+ noTF.getText() +"','" + tgl+"','" + kosuppTF.getText()+"','" + nasuppTF.getText()+"','" +
    ...
    private void perbarui(){
        try{
            setKoneksi();
            String sql="update masuk set tgltransaksi='"+tgl+"',kodesupplier='"+kosuppTF.getText()+"',namasupplier='"+nasuppTF.getText()+"',kodebarang='"+koberTF.getText()+"',kodesupplier='"+kosuppTF.getText()+
                    "',namabarang='"+nabarTF.getText()+"',jumlahmasuk='"+jumlahTF.getText()+"',keterangan='"+ketCB.getSelectedItem()+
    ...
    public void tampil(){
        Object header[]={"notransaksi","tgltransaksi","kodesupplier","namasupplier","kodebarang","namabarang","jumlahmasuk","keterangan"};
    ...
    private void hapus(){
        ...
        try{
            String sql="delete from masuk where notransaksi='"+ noTF.getText() +"'";
            st.executeUpdate(sql);
    ...
    private void initComponents() {
        ...
        jPanel2.add(ketCB, new org.netbeans.lib.awtextra.AbsoluteConstraints(130, 240, 210, 30));
        ...
        jPanel2.add(jSeparator7, new org.netbeans.lib.awtextra.AbsoluteConstraints(20, 232, 320, -1));

        jPanel1.add(jPanel2, new org.netbeans.lib.awtextra.AbsoluteConstraints(30, 230, 360, 312));
        ...
        jPanel3.add(jScrollPane1, new org.netbeans.lib.awtextra.AbsoluteConstraints(10, 64, 620, 320));
        ...
        xBT.addKeyListener(new java.awt.event.KeyAdapter() {
            public void keyReleased(java.awt.event.KeyEvent evt) {
                xBTKeyReleased(evt);
            }
        });
        jPanel3.add(xBT, new org.netbeans.lib.awtextra.AbsoluteConstraints(599, 20, 30, 40));
        ...
        jPanel3.add(cariTF, new org.netbeans.lib.awtextra.AbsoluteConstraints(360, 20, 240, 40));

        jPanel1.add(jPanel3, new org.netbeans.lib.awtextra.AbsoluteConstraints(410, 90, 640, 400));
        ...
        jPanel1.add(tambahBT, new org.netbeans.lib.awtextra.AbsoluteConstraints(410, 500, 120, 40));
        ...
        jPanel1.add(simpanBT, new org.netbeans.lib.awtextra.AbsoluteConstraints(540, 500, 120, 40));
        ...
        jPanel1.add(hapusBT, new org.netbeans.lib.awtextra.AbsoluteConstraints(800, 500, 120, 40));

        jPanel6.setBackground(new java.awt.Color(255, 255, 255));
        jPanel6.setBorder(javax.swing.BorderFactory.createTitledBorder(javax.swing.BorderFactory.createBevelBorder(javax.swing.border.BevelBorder.RAISED, java.awt.Color.gray, java.awt.Color.gray, java.awt.Color.gray, java.awt.Color.gray), "", javax.swing.border.TitledBorder.CENTER, javax.swing.border.TitledBorder.DEFAULT_POSITION, new java.awt.Font("Tahoma", 1, 12))); // NOI18N
        ...
        jPanel6.add(noTF, new org.netbeans.lib.awtextra.AbsoluteConstraints(150, 30, 190, 28));
        ...
        jPanel1.add(jPanel6, new org.netbeans.lib.awtextra.AbsoluteConstraints(30, 90, 360, 125));
        ...
        jLabel7.setText("DATA TRANSAKSI BARANG MASUK");
        ...
        jPanel1.add(editBT, new org.netbeans.lib.awtextra.AbsoluteConstraints(670, 500, 120, 40));

        getContentPane().add(jPanel1, new org.netbeans.lib.awtextra.AbsoluteConstraints(0, 10, 1070, 630));
    ...
    private void xBTKeyReleased(java.awt.event.KeyEvent evt) {//GEN-FIRST:event_xBTKeyReleased
        // TODO add your handling code here:
    }//GEN-LAST:event_xBTKeyReleased
    ...
    private void cariTFKeyReleased(java.awt.event.KeyEvent evt) {//GEN-FIRST:event_cariTFKeyReleased
        ...
        jTable1.setModel(data);
        setKoneksi();
        String sql="Select * from masuk where notransaksi like '%" + cariTF.getText() + "%'" + "or namabarang like '%" + cariTF.getText()+ "%'";
        try {
            ResultSet rs=st.executeQuery(sql);
            while (rs.next())
            {
